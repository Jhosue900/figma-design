...
function TestimonialsSection() {
  ...
  const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
    ...
    >
      <div className="relative h-full rounded-[28px] p-8 transition-all duration-500 hover:scale-[1.02] cursor-pointer"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          />
          <div>
            <h3 className="font-montserrat font-semibold text-white text-[18px] leading-tight">
              {testimonial.name}
            </h3>
            <p className="font-montserrat text-soft-gray text-[14px]">
        ...
        {/* Testimonial Text */}
        <p className="font-montserrat text-white/80 text-[15px] leading-relaxed">
          {testimonial.text}
        </p>
        ...
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-[28px]">
          <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-transparent rounded-[28px]" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section className="w-full py-20 px-8 bg-black overflow-hidden">
      <div className="max-w-full mx-auto">
        {/* Header */}
        <div className="text-center mb-4">
          <h2 
            className="font-aston text-white leading-tight mb-4"
            style={{
              fontSize: '56px',
              fontWeight: 400,
          ...
          <p 
            className="font-montserrat text-soft-gray"
            style={{
              fontSize: '18px',
              lineHeight: '28px',
          ...
          >
            Somos una empresa atenta y profesional, y nuestros clientes comparten<br />
            esa opinión. ¡Descubre lo que dicen de nosotros!
          </p>
        </div>

        {/* Navigation Hand Icon */}
        <div className="flex justify-end mb-8 pr-12 max-w-[1400px] mx-auto">
