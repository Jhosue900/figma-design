    ...
    <section className="w-full bg-black py-24 px-6 sm:px-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Bloque 1: El Mapa Interactivo Estilizado */}
          <div className="md:col-span-2 relative h-[450px] bg-[#080808] rounded-[40px] border border-white/10 overflow-hidden group shadow-2xl">
            <div 
          ...
          <div className="flex flex-col gap-6">
            <div className="flex-1 bg-gradient-to-b from-[#111] to-black p-8 rounded-[40px] border border-white/5 flex flex-col justify-center">
              ...
              <p className="font-montserrat text-white/80 text-lg leading-relaxed italic">
                "Somos un equipo <span className="text-blue-400">multi-generacional</span> y disciplinario que entiende el mercado de ambos lados del Atlántico."
              </p>
            </div>

            {/* Bloque 3: Stats Rápidas */}
            <div className="bg-white p-8 rounded-[40px] flex flex-col justify-between group hover:bg-blue-600 transition-colors duration-700">
