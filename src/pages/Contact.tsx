...
interface LocationPin { id: number; city: string; country: string; top: string; left: string; color: string }
      ...
      {locations.map((loc) => (
        ...
        >
          <div className="relative flex items-center justify-center cursor-pointer">
            <span className={`animate-ping absolute inline-flex h-6 w-6 rounded-full ${loc.color} opacity-20`} />
            <span className={`relative inline-flex rounded-full h-2.5 w-2.5 ${loc.color} shadow-[0_0_15px_rgba(255,255,255,0.4)] border border-white/10`} />
            <AnimatePresence>
              {hoveredLoc === loc.id && (
                <motion.div
