  ...
  return (
    <section className="w-full bg-transparent py-20 px-4 sm:px-6 md:px-12 font-sans relative overflow-hidden z-10 antialiased">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Contenedor de la Arquitectura de la Sección */}
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          
          {/* Columna Izquierda: Selectores / Botones */}
          <div className="w-full lg:w-1/3 flex flex-col gap-4 relative z-20">
            {servicesData.map((s) => {
              ...
              return (
                ...
                >
                  {/* Fondo sutil dinámico optimizado con CSS nativo (Mejora drástica de CPU/GPU) */}
                  <div 
                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    {/* Caja de Icono optimizada con colores sutiles fijos */}
                    <div 
                    ...
                    >
                      <SideIcon className="w-6 h-6 transition-transform duration-300 group-hover:rotate-3" />
                    </div>
                    <span 
          ...
          <div className="w-full lg:w-2/3 bg-[#0a0a0a]/70 backdrop-blur-md p-6 md:p-10 rounded-3xl border border-gray-800/60 shadow-2xl relative min-h-[480px] flex flex-col justify-between overflow-hidden will-change-transform">
            
            {/* Destello sutil optimizado por Hardware vía hardware layer translate3d */}
            <div 
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs md:text-sm text-gray-400 mt-0.5 font-light leading-normal">{f.desc}</p>
                          </div>
                        </div>
                      );
                    })}
